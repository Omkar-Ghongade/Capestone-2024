      ...
      <div className="items-center flex justify-center">
        {studentData && (
          <div className=' grid grid-cols-1 sm:grid-cols-5 gap-3 justify-center mt-8 mb-8'>
            <div className="flex flex-col col-span-2 items-center bg-white shadow-md rounded-lg p-6 w-full max-w-md shadow-md shadow-teal-100 hover:shadow-lg hover:shadow-teal-300 transform hover:-translate-y-0.5 transition duration-200 ease-in-out">
            ...
            <div className="flex flex-col col-span-3 items-center justify-center bg-white  rounded-lg p-4 w-full max-w-md mt-4 sm:mt-0 h-full shadow-md shadow-teal-100 hover:shadow-lg hover:shadow-teal-300 transform hover:-translate-y-0.5 transition duration-200 ease-in-out">
